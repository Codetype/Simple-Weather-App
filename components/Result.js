...
export default class Result extends Component {
    ...
    render () {
        const weather = this.props.navigation.getParam('weather');
        const {error, city, humidity, avgTemp, cloudiness, visibility, sunset, sunrise, pressure, wind, temp, weatherState} = weather;
        let content = null;
        ...
        return (
            <View className="result">
                {!error ? content : <Text style={styles.errorMessage}>Nie znaleziono: {city}</Text>}
            </View>
        )
    }
};
